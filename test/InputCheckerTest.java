...
public class InputCheckerTest {
    ...
    public void valid() {
        ...
        ojt_ecsite.InputChecker.CheckResult checkResult =
                inputChecker.validateSearchParameters(map);

        assertThat(checkResult,is(checkResult.VALID));
    }

    /**
     *  商品名,下限価格,上限価格のいずれも指定していないとき,
     *  不合格を示す結果"INVALID_ALL_INPUT_EMPTY"を返す.
     */
    @Test
    ...
    /**
     *  シングルクォーテーション(')を含む商品名を指定しているとき,
     *  不合格を示す結果"INVALID_CONTAINS_QUOTATION"を返す.
     */
    @Test
    ...
    public void productNameMaxLength() {
        ...
        String[] NameArray = {"親譲りの無鉄砲で小供の時から損ばかりしている。小学校に居る時分学校の二階から飛び降りて一週間ほど腰を抜かした事がある。"
                ...
                + "この次は抜かさずに飛んで見せますと答えた。（青空文庫より）親譲りの無"};
        String[] minPriceArray = {""};
        String[] maxPriceArray = {""};
        map.put("productName", NameArray);
        map.put("minPrice", minPriceArray);
    ...
    public void productNameExceedsLimit() {
        ...
        String[] NameArray = {"親譲りの無鉄砲で小供の時から損ばかりしている。小学校に居る時分学校の二階から飛び降りて一週間ほど腰を抜かした事がある。"
                ...
                + "同級生の一人が冗談に、いくら威張っても、そこから飛び降りる事は出来まい。弱虫やーい。と囃したからである。"
                + "小使に負ぶさって帰って来た時、おやじが大きな眼をして二階ぐらいから飛び降りて腰を抜かす奴があるかと云ったから、"
                + "この次は抜かさずに飛んで見せますと答えた。（青空文庫より）親譲りの無鉄"};
        String[] minPriceArray = {""};
        String[] maxPriceArray = {""};
        map.put("productName", NameArray);
        map.put("minPrice", minPriceArray);
    ...
    /**
     * 指定した下限価格が上限価格を上回っているとき,
     * 不合格を示す結果"INVALID_REVERSED_PRICE_RANGE"を返す.
     */
    @Test
